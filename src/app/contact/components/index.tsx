...
const ContactUs: FC<ContactUsProps> = ({}) => {
  return (
    <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-[100px] py-8 sm:py-12 md:py-16 lg:py-[50px] flex flex-col lg:flex-row gap-8 sm:gap-12 md:gap-16 lg:gap-24 justify-between">
      <div className="flex flex-col gap-6 sm:gap-8 md:gap-10 lg:gap-11 w-full lg:max-w-[338px]">
