...
const ServicesCard = ({
  ...
  return (
    <div className="relative flex flex-col flex-1 h-[570px] items-center border-r border-solid border-gray-300 group">
      <div
        className="absolute inset-0 bg-cover bg-no-repeat bg-center group-hover:flex h-full w-full z-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
        style={{ backgroundImage: `url(${backgroundImg})` }}
      ></div>

      <div className="flex transition-opacity duration-500 hover:bg-primary hover:bg-opacity-75 z-10 flex-col h-full justify-between items-center p-3">
